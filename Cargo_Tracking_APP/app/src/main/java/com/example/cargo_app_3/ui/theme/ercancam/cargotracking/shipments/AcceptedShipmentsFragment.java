...
public class AcceptedShipmentsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = inflater.inflate(R.layout.fragment_accepted_shipments, container, false);
            ...
            public void onResponse(Call<List<Shipment>> call, Response<List<Shipment>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    for (Shipment s : response.body()) {
                        if ("IN_TRANSIT".equalsIgnoreCase(s.getStatus()))
                            shipmentList.add(s);
                    }
